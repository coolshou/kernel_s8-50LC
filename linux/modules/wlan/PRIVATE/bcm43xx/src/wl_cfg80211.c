 ...
 *
 * $Id: wl_cfg80211.c 443591 2013-12-17 02:52:39Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
...
wl_cfg80211_add_monitor_if(char *name)
{
	...
	return (ndev_to_cfgdev(ndev) ? ndev_to_cfgdev(ndev) : ERR_PTR(-EINVAL));
#endif /* WL_ENABLE_P2P_IF || WL_CFG80211_P2P_DEV_IF */
}
	...
	struct cfg80211_connect_params *sme)
{
	...
	if (unlikely(sme->ssid_len > DOT11_MAX_SSID_LEN)) {
		WL_ERR(("Invalid SSID info: SSID=%s, length=%zu\n",
